...
\begin{frame}{Context - Generative data analysis}
  ...
  \item We can write down a \emph{likelihood} of getting the observations we got: $\mathcal{L}(y_i | x_i, \theta) = g(y_i, \hat{y}_i, \theta)$
...
\begin{frame}{Context - Generative data analysis}
  ...
  \item (given samples, we can draw \emph{contours}):
  \end{itemize}
